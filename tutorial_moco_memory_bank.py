...
if __name__ == '__main__':
    ...
    # )
    #
    # torch.save(model.backbone, 'cifar_800epoch_moco.pth')

    backbone = torch.load('cifar_800epoch_moco.pth')
    backbone.eval()
    ...
    torch.save(classifier, 'cifar_200epoch_linear.pth')

    # classifier = torch.load('cifar_200epoch_linear.pth')
    # print(classifier)
